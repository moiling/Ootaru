		...
		void Update () {
			...
			for (var i = 0; i < Creator.Height; i++) {
				...
				for (var j = 0; j < Creator.Width; j++) {
					var currentType = ((GameObject)Creator.Blocks[Creator.Width * i + j]).GetComponent<NonogramsBlock>().CurrentType;
			...
			for (var i = 0; i < Creator.Width; i++) {
				...
				for (var j = 0; j < Creator.Height; j++) {
					var currentType = ((GameObject)Creator.Blocks[Creator.Width * j + i]).GetComponent<NonogramsBlock>().CurrentType;
